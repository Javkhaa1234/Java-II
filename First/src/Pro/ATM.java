...
public class ATM extends JFrame {
	...
	protected void buildApp(){
		...
		JLabel inputDisplay = new JLabel("Сонголтын төрлүүд:");
		...
		JButton clear = new JButton("Арилгах");
		bPConst.gridx = 2;
		bPConst.gridy = 3;
		clear.setSize(new Dimension(200, 30));
		buttonPanel.add(clear, bPConst);
		JButton enter = new JButton("Оруулах");
		bPConst.gridx = 3;
		bPConst.gridy = 3;
